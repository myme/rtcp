...
interface Props {
  icon: 'clipboard' | 'trash' | 'eye' | 'eye-slash',
}
...
export default function Icon({ icon }: Props) {
  switch (icon) {
    ...
    case 'eye':
      return (
        <svg width="1.1em" height="0.9em" className="icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
    ...
    case 'eye-slash':
      return (
        <svg width="1.1em" height="0.9em" className="icon" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="eye-slash" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
